...
export const EditTeamWrapper = styled.div`
...
`
export const EditTeamHeadline = styled(TextFontS1SubtitleBasic1000)`
...
export const TeamNameContainer = styled.div`
   ${tw`mt-24px`}
`
export const TeamDescriptionContainer = styled(TeamNameContainer)``

export const EditTeamMembersContainer = styled(TeamDescriptionContainer)``

export const SaveButtonContainer = styled.div`
   ${tw`w-800 flex justify-end items-center mt-24px`}
`

export const MembersContainer = styled(EditTeamMembersContainer)`
   ${tw`mt-16px`}
`
