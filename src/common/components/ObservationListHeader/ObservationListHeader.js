...
class ObservationListHeader extends Component {
    render() {
        ...
        return (
            <TableRow >
                <TableData><TableData>{title}</TableData></TableData>
                <TableData><TableData>{reportedOn}</TableData></TableData>
                <TableData>
                    <PersonDetails>
                ...
                <TableData><TableData>{dueDate}</TableData></TableData>
                <TableData>
                    <Image className={'message-icon'} src={'https://cdn.zeplin.io/5d0afc9102b7fa56760995cc/assets/25193dcb-b81b-48a0-8ce4-ef53a4775749.svg'} />
                </TableData>
            </TableRow>
        )
    }
