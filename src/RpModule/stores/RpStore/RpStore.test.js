...
describe("RpStore Store tests", () => {
    ...
    it("should test get Assigned observations list fetching state", () => {
        const mockAssignedObservationListPromise = new Promise(function (resolve, reject) { });
        const mockAssignedObservationListApi = jest.fn();
        mockAssignedObservationListApi.mockReturnValue(mockAssignedObservationListPromise);
    ...
    it("should test get Update observations list fetching state", () => {
        const mockUpdateObservationPromise = new Promise(function (resolve, reject) { })
    ...
    it("should test get Update observations list success state", async () => {
        ...
        const mockUpdateObservationApi = jest.fn().mockReturnValue(mockUpdateObservationPromise);
        rpObsevationsAPI.updateObservationApi = mockUpdateObservationApi;
    ...
    it("Should test go to previous page ", () => {
        let assignedObservationsCurrentPage = rpStore.assignedObservationsCurrentPage;
        rpStore.assignedObservationsGoToPreviousPage();
        expect(rpStore.assignedObservationsCurrentPage).toBe(assignedObservationsCurrentPage - 1);
    ...
    it("Should test go to random Page", () => {
        ...
        expect(rpStore.assignedObservationsCurrentPage).toBe(assignedObservationsCurrentPage);
